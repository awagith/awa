...
class ProductByCat extends \Magento\Catalog\Block\Product\AbstractProduct 
{
    ...
    public function getSoldProduct($idProduct){
        $SoldProducts = $this->soldProductFactory->create();
        $product = $SoldProducts->addOrderedQty()->addAttributeToFilter('product_id', $idProduct)->setOrder('ordered_qty', 'desc')->getFirstItem();
