...
| BP-34 | `content-visibility: auto` expandido para footer (`contain-intrinsic-size: auto 400px`) e FAQ homepage (`auto 300px`) — melhora render performance below-the-fold | `awa-layout.css`, `awa-consistency-home5.css` | 2026-02-24 |